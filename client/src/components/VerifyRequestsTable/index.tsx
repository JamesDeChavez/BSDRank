...
import { GET_USER, GET_VERIFY_REQUESTS } from '../../graphql/query'
import classNames from 'classnames'
import { UPDATE_USER_FOR_VERIFY_REQUEST, UPDATE_VERIFY_REQUEST } from '../../graphql/mutations'
import './styles.css'
...
const VerifyRequestsTable = () => {
    ...
    const handleRequestClick = async (e: React.MouseEvent<HTMLDivElement, MouseEvent>, request: any) => {
        ...
        const { username, pendingVerified, verified } = userData.data.user
